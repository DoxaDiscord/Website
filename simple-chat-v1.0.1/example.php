...
<head>
	...
	<style type="text/css">
		...
		body { margin: 2em; padding: 0; font-family: sans-serif; font-size: medium; color: #0B27D8; }
		h1 { margin: 0; padding: 0; font-size: 2em; }
		p.subtitle { margin: 0; padding: 0 0 0 0.125em; font-size: 0.77em; color: Black; }
		...
		ul#messages li small { display: block; font-size: 0.59em; color: Black; }
		ul#messages li.pending { color: #0B27D8; }
